...
export const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    products: [
      { id: "01", title: "Vanitory suspendido", description: "Flotante, fácil de limpiar y moderno." },
      { id: "02", title: "Vanitory de pie", description: "Con puertas y estantes, a la medida de tu bacha." },
      { id: "03", title: "Espejo con marco de madera", description: "Marcos en madera en el tamaño que necesites." },
      { id: "04", title: "Botiquín con espejo", description: "Guardado oculto detrás del espejo." },
      { id: "05", title: "Columna de baño", description: "Guardado vertical para toallas y productos." },
